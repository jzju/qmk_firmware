...
[SYMB] = LAYOUT_ergodox(
       ...
       KC_LSFT, NO_LESS, KC_PERC, NO_LBRC, NO_RBRC, NO_AMPR, KC_NO,
       ...
       KC_NO, NO_TILD, NO_AA,   NO_AE,   NO_OSLH, KC_NO, KC_RSFT,
                         KC_NO,KC_NO,KC_NO,KC_NO, KC_NO,
       KC_NO, KC_NO,
       KC_NO,
...
[GAME] = LAYOUT_ergodox(
        ...
        KC_B,     KC_LSFT,   KC_Z,   KC_X,   KC_C,   KC_V,   KC_G,
        KC_H,     KC_LCTL,   KC_LGUI, KC_LALT,KC_LALT,
                                                     KC_NO, TO(BASE),
                                                              KC_LOCK,
...
[STAR] = LAYOUT_ergodox(  // layer 0 : default
        ...
        KC_TAB,    KC_Q,      KC_W,   KC_F,   KC_P,   KC_B,   KC_7,
        KC_TAB,    KC_A,      KC_R,   KC_S,   KC_T,   KC_G,
