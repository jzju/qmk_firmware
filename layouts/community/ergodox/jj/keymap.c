...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        // left hand
        KC_ESC,      KC_7,      KC_5,   KC_3,   KC_1,   KC_9,   KC_J,
        KC_TAB,      KC_Q,      KC_W,   KC_F,   KC_P,   KC_B,   KC_M,
        KC_TAB,      KC_A,      KC_R,   KC_S,   KC_T,   KC_G,
        KC_LSFT,     KC_Z,      KC_X,   KC_C,   KC_D,   KC_V,   KC_K,
 ...
 * |        |   !  |   @  |   {  |   }  |   %  |      |           | Next |   ^  |   =  |   *  |   +  |   ?  |   F12  |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |   #  |   $  |   (  |   )  |   &  |------|           |------|   "  |MsLeft|MsDown| MsUp |MsRght|  PrtSc |
 * |--------+------+------+------+------+------|      |           | Prev |------+------+------+------+------+--------|
 * |        |   <  |   >  |   [  |   ]  |   |  |      |           |      |   ~  |   Å  |   Ä  |   Ö  |   \  |  Sleep |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      |      |      |      |      |                                       | Mclk |      |      |      |      |
...
[SYMB] = LAYOUT_ergodox(
       ...
       KC_NO, NO_LESS, NO_GRTR, NO_LBRC, NO_RBRC, NO_PIPE, KC_NO,
